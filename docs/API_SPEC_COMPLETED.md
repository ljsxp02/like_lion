...
| key | 타입 | 필수 | 설명 | 예시 |
| --- | --- | --- | --- | --- |
| verificationToken | String | Y | 이메일 인증 완료 토큰 | `email-verification-token` |
| email | String | Y | 인증된 이메일 | `student@kw.ac.kr` |
| password | String | Y | 비밀번호 원문. 서버에서 해시 처리 | `Password123!` |
...
Errors: `AUTH_400`, `USER_409`, `COMMON_500`
